...
#include "Runtime/IO/YosefResource.h"
...
#define TexcoordMask(v) (v&_00000000_00000000_00000000_00000100)
	...
	void ImageSprite::SetColor(YOSEFUInt8 r,YOSEFUInt8 g,YOSEFUInt8 b,YOSEFUInt8 a){
	...
	void ImageSprite::SetAdditionalColor(float r, float g, float b, float a) {
		mAddtionalColor.Set(YOSEF_MIN(r, 1.0f), YOSEF_MIN(g, 1.0f), YOSEF_MIN(b, 1.0f), YOSEF_MIN(a, 1.0f));
		for (int i = 0; i < 4; ++i) {
			UpdateVertexTangent(i, mColor.v[0], mColor.v[1], mColor.v[2], mColor.v[3]);
		}
	}
	...
	void ImageSprite::SetAlpha(YOSEFUInt8 alpha){
