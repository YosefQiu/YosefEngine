...
namespace YOSEF {
	...
	void TranslateAnimation::OnUpdateStepAnimation(AnimationKeyFrame*keyframe) {
		...
		target_gameobject->SetLocalPosition(target_gameobject->mWorldTransform.mPosition.x + trasform_key_frame->mPosition.x,
				target_gameobject->mWorldTransform.mPosition.y + trasform_key_frame->mPosition.y,
				target_gameobject->mWorldTransform.mPosition.z + trasform_key_frame->mPosition.z);
	}
	...
	void TranslateAnimation::UpdateProperty(float percent, AnimationKeyFrame*start_frame, AnimationKeyFrame*end_frame) {
		...
		Vector3f pos = Lerp(start_key_frame->mPosition, end_key_frame->mPosition, percent);
			target_gameobject->SetLocalPosition(target_gameobject->mWorldTransform.mPosition.x + pos.x,
				target_gameobject->mWorldTransform.mPosition.y + pos.y,
				target_gameobject->mWorldTransform.mPosition.z + pos.z);
	}
	void RotateAnimation::OnUpdateStepAnimation(AnimationKeyFrame*keyframe) {
		...
		target_gameobject->SetLocalRotation(target_gameobject->mWorldTransform.mRotation.x + trasform_key_frame->mRotation.x,
				target_gameobject->mWorldTransform.mRotation.y + trasform_key_frame->mRotation.y,
				target_gameobject->mWorldTransform.mRotation.z + trasform_key_frame->mRotation.z);
	}
	...
	void RotateAnimation::UpdateProperty(float percent, AnimationKeyFrame*start_frame, AnimationKeyFrame*end_frame) {
		...
		target_gameobject->SetLocalRotation(target_gameobject->mWorldTransform.mRotation.x + rotation.x,
				target_gameobject->mWorldTransform.mRotation.y + rotation.y,
				target_gameobject->mWorldTransform.mRotation.z + rotation.z);
	}
	void ScaleAnimation::OnUpdateStepAnimation(AnimationKeyFrame*keyframe) {
		...
		target_gameobject->SetLocalScale(target_gameobject->mWorldTransform.mScale.x * trasform_key_frame->mScale.x,
				target_gameobject->mWorldTransform.mScale.y * trasform_key_frame->mScale.y,
				target_gameobject->mWorldTransform.mScale.z * trasform_key_frame->mScale.z);
	}
	...
	void ScaleAnimation::UpdateProperty(float percent, AnimationKeyFrame*start_frame, AnimationKeyFrame*end_frame) {
		...
		target_gameobject->SetLocalScale(target_gameobject->mWorldTransform.mScale.x * scale.x,
				target_gameobject->mWorldTransform.mScale.y * scale.y,
				target_gameobject->mWorldTransform.mScale.z * scale.z);
	}
	void ShearAnimation::OnUpdateStepAnimation(AnimationKeyFrame*keyframe) {
		...
		target_gameobject->mLocalTransform.SetLocalShearing(target_gameobject->mWorldTransform.mShearing.x + trasform_key_frame->mShear.x,
				target_gameobject->mWorldTransform.mShearing.y + trasform_key_frame->mShear.y, 0.0f);
	}
	...
	void ShearAnimation::UpdateProperty(float percent, AnimationKeyFrame*start_frame, AnimationKeyFrame*end_frame) {
		...
		target_gameobject->mLocalTransform.SetLocalShearing(target_gameobject->mWorldTransform.mShearing.x + shearing.x,
				target_gameobject->mWorldTransform.mShearing.y + shearing.y,
				target_gameobject->mWorldTransform.mShearing.z + shearing.z);
	}
}