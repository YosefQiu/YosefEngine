...
namespace YOSEF{
	...
	const Sphere&Avatar::GetBoundingVolume() {
		if (mbIsBoundingVolumeDirty) {
			...
			float scaleX = YOSEF_SQRTF(YOSEF_SQUARE(world_matrix.mData[0]) + YOSEF_SQUARE(world_matrix.mData[1]) + YOSEF_SQUARE(world_matrix.mData[2]));
			float scaleY = YOSEF_SQRTF(YOSEF_SQUARE(world_matrix.mData[4]) + YOSEF_SQUARE(world_matrix.mData[5]) + YOSEF_SQUARE(world_matrix.mData[6]));
			float scaleZ = YOSEF_SQRTF(YOSEF_SQUARE(world_matrix.mData[8]) + YOSEF_SQUARE(world_matrix.mData[9]) + YOSEF_SQUARE(world_matrix.mData[10]));
