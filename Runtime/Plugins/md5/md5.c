...
void md5hexa(const char *message, long len, char *output) {
	...
	word32tobytes(d, md5buffer);
	sprintf(output,"%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x", md5buffer[0], md5buffer[1], md5buffer[2], md5buffer[3]
		, md5buffer[4], md5buffer[5], md5buffer[6], md5buffer[7], md5buffer[8], md5buffer[9], md5buffer[10], md5buffer[11]
		, md5buffer[12], md5buffer[13], md5buffer[14], md5buffer[15]);
}
void md5bytes2hexa(const unsigned char *md5buffer, char *output) {
	sprintf(output, "%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x", md5buffer[0], md5buffer[1], md5buffer[2], md5buffer[3]
		, md5buffer[4], md5buffer[5], md5buffer[6], md5buffer[7], md5buffer[8], md5buffer[9], md5buffer[10], md5buffer[11]
		, md5buffer[12], md5buffer[13], md5buffer[14], md5buffer[15]);
}
