...
namespace YOSEF{
	...
	{
		mMin.x = YOSEF_MIN(mMin.x, inPoint.x);
		mMin.y = YOSEF_MIN(mMin.y, inPoint.y);
		mMin.z = YOSEF_MIN(mMin.z, inPoint.z);
		mMax.x = YOSEF_MAX(mMax.x, inPoint.x);
		mMax.y = YOSEF_MAX(mMax.y, inPoint.y);
		mMax.z = YOSEF_MAX(mMax.z, inPoint.z);
	}
