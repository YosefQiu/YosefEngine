...
namespace YOSEF{
	...
	public:
		...
		FT_Glyph GetGlyph(YOSEFUInt32 charCode, int point_size);
		...
		CharInfo * RenderingCurrentChar(YOSEFUInt32 charCode, FT_Bitmap*font, FT_Bitmap*stroker, int shadow_x, int shadow_y, YOSEF::Data&imageData);
